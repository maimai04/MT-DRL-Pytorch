...
class PPO_algorithm():
    ...
    and this book, which gives a high-level intro to PPO with pytorch:
    - https://www.amazon.com/Deep-Reinforcement-Learning-Hands-optimization/dp/1838826998
    """
    def __init__(self,
                 # classes we need to pass for agent construction
                 env_train, # training environment
                 brain, # actor-critic network
                 buffer, # storage class for storing collected trajectories
                 current_episode: int,
                 # number of stocks, needed for the scaling function
                 assets_dim: int,
